...
def parse_args():
    ...
    #     default="/data/jupyter/PETR/configs/petr/petr_r50_16x2_100e_coco.py"
    # )
    parser.add_argument(
        'config', 
        help='test config file path',
    ...
    #     default="/data/jupyter/PETR/checkpoint/petr_r50_16x2_100e_coco.pth"
    # )
    parser.add_argument(
        'checkpoint', 
        help='checkpoint file',
    ...
    parser.add_argument(
        ...
        default="/data/jupyter/PETR/results"
    )
    parser.add_argument(
        '--show-score-thr',
        type=float,
...
def main():
    ...
    model = build_model(cfg.model, test_cfg=cfg.get('test_cfg'))  # cfg.get('test_cfg') = None
    ...
    if 'CLASSES' in checkpoint.get('meta', {}):
        model.CLASSES = checkpoint['meta']['CLASSES']  # person
    else:
